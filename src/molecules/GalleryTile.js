const GalleryTile = (props) => {
	return (
		<div className={`col-span-6 md:col-span-3 relative ${props.options}`}>
			<img src={props.tile} alt='hand with painted nails' className='shadow-lg' />
			<a href='https://www.instagram.com/zvi_nails/?hl=en' target='_blank' rel='noreferrer'>
				<div className='opacity-0 hover:opacity-30 transition-opacity absolute top-0 left-0 h-full w-full bg-gray-400 duration-300 flex justify-center items-center'>
