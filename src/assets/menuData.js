export const menuData = {
	...
	kidsPackages: [
		...
		{ name: 'Hand Polish Change', price: '$5+' },
		{ name: 'Toes Polish Change', price: '$7+' },
	],
	pedicures: [
		{
	...
	waxingAndThreading: [
		...
		{ name: 'Upper Lip Wax', price: '$6+' },
		{ name: 'Upper Lip Threading', price: '$7+' },
		{ name: 'Chin Wax', price: '$6+' },
		{ name: 'Chin Threading', price: '$7+' },
		{ name: 'Sideburns', price: '$15+' },
		{ name: 'Full Face Wax', price: '$30+' },
		{ name: 'Full Face Threading', price: '$37+' },
		{ name: 'Chest', price: '$30+' },
		{ name: 'Back', price: '$50+' },
		{ name: 'Full Arms', price: '$40+' },
		{ name: 'Lower Arms', price: '$25+' },
