...
const Location = () => {
	...
	return (
		<React.Fragment>
			<section className={`${styleOptions()} bg-neutral md:mt-4 md-custom-container`}>
				<span id='contact' className='block relative -top-20' />
				<div className='py-8 flex justify-evenly items-start'>
					<div>
						<h2 className='md:text-2xl text-lg font-display mb-4'>
							<b>
